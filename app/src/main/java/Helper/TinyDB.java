...
public class TinyDB {
    ...
    public ArrayList<Food_Domain> getListObject(String key){
        Gson gson = new Gson();


        ArrayList<String> objStrings = getListString(key);
        ArrayList<Food_Domain> playerList =  new ArrayList<Food_Domain>();

        for(String jObjString : objStrings){
            Food_Domain player  = gson.fromJson(jObjString,  Food_Domain.class);
    ...
    public void putListObject(String key, ArrayList<Food_Domain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Food_Domain player: playerList){
